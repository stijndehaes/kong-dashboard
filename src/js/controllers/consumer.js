angular.module('app').controller(
  "ConsumerController",
  ["$scope", "Kong", "$location", "$routeParams", "consumer", "Alert", "env", ConsumerController]
);

function ConsumerController($scope, Kong, $location, $routeParams, consumer, Alert, env) {
  $scope.schema = env.schemas.consumer;
  $scope.errors = {};
